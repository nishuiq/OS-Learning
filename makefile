...
$(BUILD_DIR)/thread.o: thread/thread.c thread/thread.h lib/stdint.h lib/kernel/list.h \
    	kernel/global.h lib/string.h kernel/debug.h kernel/interrupt.h \
    	lib/kernel/print.h kernel/memory.h lib/kernel/bitmap.h \
    	userprog/process.h thread/thread.h
	$(CC) $(CFLAGS) $< -o $@
